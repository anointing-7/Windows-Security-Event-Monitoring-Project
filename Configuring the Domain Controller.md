...
-	After setting the static IP, I had issues connecting to the internet. I did some troubleshooting and realized it was a DNS problem and set the preferred DNS to 8.8.8.8, which resolved the issue.
